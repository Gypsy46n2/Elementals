...
func _init_weapons() -> void:
	...
	_add("Dagger", "2 gp", "1d4", "piercing", 1, "Finesse, light, thrown (range 20/60)", dagger_icon)
	_add("Greatclub", "2 sp", "1d8", "bludgeoning", 10, "Two-handed", greatclub_icon)
	_add("Handaxe", "5 gp", "1d6", "slashing", 2, "Light, thrown (range 20/60)", handaxe_icon)
	_add("Javelin", "5 sp", "1d6", "piercing", 2, "Thrown (range 30/120)", javelin_icon)
	_add("Light hammer", "2 gp", "1d4", "bludgeoning", 2, "Light, thrown (range 20/60)", light_hammer_icon)
	...
	_add("Spear", "1 gp", "1d6", "piercing", 3, "Thrown (range 20/60), versatile (1d8)", spear_icon)
	_add("Unarmed strike", "0 gp", "1", "bludgeoning", 0, "-", unarmed_strike_icon)
	_add("Crossbow, light", "25 gp", "1d8", "piercing", 5, "Ammunition (range 80/320), loading, two-handed", crossbow_light_icon)
	_add("Dart", "5 cp", "1d4", "piercing", 0.25, "Finesse, thrown (range 20/60)", dart_icon)
	_add("Shortbow", "25 gp", "1d6", "piercing", 2, "Ammunition (range 80/320), two-handed", shortbow_icon)
	_add("Sling", "1 sp", "1d4", "bludgeoning", 0, "Ammunition (range 30/120)", sling_icon)
	...
	_add("Trident", "5 gp", "1d6", "piercing", 4, "Thrown (range 20/60), versatile (1d8)", trident_icon)
	...
	_add("Blowgun", "10 gp", "1", "piercing", 1, "Ammunition (range 25/100), loading", blowgun_icon)
	_add("Crossbow, hand", "75 gp", "1d6", "piercing", 3, "Ammunition (range 30/120), light, loading", crossbow_hand_icon)
	_add("Crossbow, heavy", "50 gp", "1d10", "piercing", 18, "Ammunition (range 100/400), heavy, loading, two-handed", crossbow_heavy_icon)
	_add("Longbow", "50 gp", "1d8", "piercing", 2, "Ammunition (range 150/600), heavy, two-handed", longbow_icon)
