...
func _init_weapons() -> void:
	...
	_add("Shortbow", "25 gp", "1d6", "piercing", 2, "Ammunition (range 80/320), two-handed, ammo 20", shortbow_icon, "res://Actor/Projectiles/ShortbowProjectile.tscn")
	...
	_add("Scimitar", "25 gp", "1d6", "slashing", 3, "Finesse, light", scimitar_icon, "res://Actor/Projectiles/ScimitarProjectile.tscn")
